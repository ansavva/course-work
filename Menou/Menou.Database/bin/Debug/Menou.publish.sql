...
GO
PRINT N'Creating [dbo].[FK_MenuItem_Restaurant]...';


GO
ALTER TABLE [dbo].[MenuItem]
    ADD CONSTRAINT [FK_MenuItem_Restaurant] FOREIGN KEY ([RestaurantId]) REFERENCES [dbo].[Restaurant] ([Id]);
...
INSERT INTO #Restaurant ([Name], [CreatedDate], [ModifiedDate])
VALUES ('Andreas'' Itlian', GETDATE(), GETDATE())
...
INSERT INTO #MenuItem ([Title], [Description], [RestaurantId], [CreatedDate], [ModifiedDate])
VALUES (
